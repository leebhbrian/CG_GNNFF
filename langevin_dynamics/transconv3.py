...
class TransformerConv3(MessagePassing2):
    _alpha: OptTensor
    ...
    def __init__(
        ...
        **kwargs,
        ...
        super(TransformerConv3, self).__init__(node_dim=0, **kwargs)
    ...
    def forward(self, x: Union[Tensor, PairTensor], edge_index: Adj,
        ...
        if uvec is not None:
            ...
            outx=(scatter_sum(out2inx,edge_index[1,:],dim=0,dim_size=dim_sz)-scatter_sum(out2inx,edge_index[0,:],dim=0,dim_size=dim_sz))/2.0
            outy=(scatter_sum(out2iny,edge_index[1,:],dim=0,dim_size=dim_sz)-scatter_sum(out2iny,edge_index[0,:],dim=0,dim_size=dim_sz))/2.0
            outz=(scatter_sum(out2inz,edge_index[1,:],dim=0,dim_size=dim_sz)-scatter_sum(out2inz,edge_index[0,:],dim=0,dim_size=dim_sz))/2.0
